...
val extendedLight = ExtendedColorScheme(
    ...
    danger = ColorFamily(
        dangerLight,
        onDangerLight,
        dangerContainerLight,
        onDangerContainerLight,
    ),
)
...
val extendedLightMediumContrast = ExtendedColorScheme(
    ...
    danger = ColorFamily(
        dangerLightMediumContrast,
        onDangerLightMediumContrast,
        dangerContainerLightMediumContrast,
        onDangerContainerLightMediumContrast,
    ),
)
...
val extendedLightHighContrast = ExtendedColorScheme(
    ...
    danger = ColorFamily(
        dangerLightHighContrast,
        onDangerLightHighContrast,
        dangerContainerLightHighContrast,
        onDangerContainerLightHighContrast,
    ),
)
...
val extendedDarkMediumContrast = ExtendedColorScheme(
    ...
    danger = ColorFamily(
        dangerDarkMediumContrast,
        onDangerDarkMediumContrast,
        dangerContainerDarkMediumContrast,
        onDangerContainerDarkMediumContrast,
    ),
)
...
val extendedDarkHighContrast = ExtendedColorScheme(
    ...
    danger = ColorFamily(
        dangerDarkHighContrast,
        onDangerDarkHighContrast,
        dangerContainerDarkHighContrast,
        onDangerContainerDarkHighContrast,
    ),
)
