package com.srfmolina.krocy.ui.presentation.common.selector.location
...
internal class LocationSelectorViewModel(
    ...
    private suspend fun loadOptions() = getLocationsUseCase().onSuccess { quantityUnits ->
        setState {
            OptionSelectorState(
