package com.srfmolina.krocy.ui.presentation.common.selector.stock.unit
...
internal class StockUnitSelectorViewModel(
    ...
    private suspend fun loadOptions() = getQuantityUnitsUseCase().onSuccess { quantityUnits ->
        setState {
            OptionSelectorState(
