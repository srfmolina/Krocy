...
| **allowSubproductSubstitution** | **kotlin.Int** | &#x60;true&#x60; when any in stock sub product should be used when the given product is a parent product and currently not in stock |  [optional] |
