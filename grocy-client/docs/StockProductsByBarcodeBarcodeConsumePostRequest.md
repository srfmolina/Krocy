...
# StockProductsByBarcodeBarcodeConsumePostRequest
...
| **spoiled** | **kotlin.Int** | True when the given product was spoiled, defaults to false |  [optional] |
...
| **exactAmount** | **kotlin.Int** | For tare weight handling enabled products, &#x60;true&#x60; when the given is the absolute amount to be consumed, not the amount including the container weight |  [optional] |
| **allowSubproductSubstitution** | **kotlin.Int** | &#x60;rue&#x60; when any in stock sub product should be used when the given product is a parent product and currently not in stock |  [optional] |
