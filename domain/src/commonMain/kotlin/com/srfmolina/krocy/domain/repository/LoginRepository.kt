...
interface LoginRepository {
    /**
     * Tests connectivity and authentication against [config] without persisting the config
     * itself. For Home Assistant configs this first acquires (and stores) an ingress session.
